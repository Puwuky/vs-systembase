<template>
    <v-dialog :model-value="modelValue" @update:model-value="cerrar" max-width="500">
        <v-card>
            <v-card-title>
            ...
            <v-card-text>
                <v-checkbox v-for="menu in menus" :key="menu.id" v-model="menu.asignado" :label="menu.titulo" />
            </v-card-text>
